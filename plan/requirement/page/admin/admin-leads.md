...
- [ ] Leads table hiển thị đầy đủ thông tin từ form contact
- [ ] Lead detail page cho phép xem message và chuyển status
...
```
Contact Form → leads (Type B, status=new) → /admin/leads (admin xử lý tiếp cận)
```
