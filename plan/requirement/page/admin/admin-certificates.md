...
2. Kiểm tra học viên đủ điều kiện nhận [[requirement/page/website/certificate|certificate]]
3. Cấp [[requirement/page/website/certificate|certificate]] cho học viên
4. Tạo Certificate ID duy nhất
5. Chọn [[requirement/page/website/certificate|certificate]] template và tạo/tải file PDF chứng chỉ
6. Revoke chứng chỉ nếu cần
7. Copy link verify [[requirement/page/website/certificate|certificate]]
```

Trang này quản lý bước cuối của quá trình học:

```text
Học viên học lesson → nộp final project → [[requirement/page/admin/admin|admin]] duyệt → cấp [[requirement/page/website/certificate|certificate]]
```
...
- Chọn học viên
- Chọn khóa
- Chọn active [[requirement/page/website/certificate|certificate]] template
- Tạo Certificate ID
- Generate PDF
```
...
Hiển thị học viên **đủ điều kiện nhận [[requirement/page/website/certificate|certificate]] nhưng chưa được cấp**.

Điều kiện đủ:

```text
Học viên đủ điều kiện [[requirement/page/website/certificate|certificate]] khi:
...
2. Hoàn thành TẤT CẢ lesson có is_required_for_completion = true:
   ...
   - assignment/final_project: [[requirement/page/instructor/submissions|submissions]].status = approved
3. Final project (nếu khóa có lesson type = final_project) đã được approved
4. Chưa có [[requirement/page/website/certificate|certificate]] valid cho course đó
```
...
Khi [[requirement/page/admin/admin|admin]] bấm `Cấp chứng chỉ`, mở modal.
...
| Certificate ID       | Có                   | Tự generate, [[requirement/page/admin/admin|admin]] có thể xem |
...
# 9. Actions trên [[requirement/page/website/certificate|certificate]]

| Action             | Chức năng                            |
| ------------------ | ------------------------------------ |
| `View`             | Xem chi tiết [[requirement/page/website/certificate|certificate]]             |
...
Khi [[requirement/page/admin/admin|admin]] bấm `View`, mở drawer/modal chi tiết.
...
| Audit info       | Issued by ([[requirement/page/admin/admin|admin]]), revoked by ([[requirement/page/admin/admin|admin]] nếu có) |
...
Mỗi [[requirement/page/website/certificate|certificate]] phải có link verify:
...
1. Mở link verify
2. Copy link verify
3. Tải [[requirement/page/website/certificate|certificate]] PDF
```
...
| ------------------------------ | ---------------------------------------- |
| Học viên chưa đủ điều kiện     | Không cho cấp [[requirement/page/website/certificate|certificate]]                |
| Chưa có final project approved | Không cho cấp [[requirement/page/website/certificate|certificate]]                |
| Đã có [[requirement/page/website/certificate|certificate]] cùng course  | Không cấp duplicate                      |
| Certificate ID bị trùng        | Generate lại ID                          |
| Certificate đã revoked         | Không hiển thị là valid ở verify [[requirement/page|page]]    |
| Revoke [[requirement/page/website/certificate|certificate]]             | Bắt buộc nhập lý do                      |
...
| Issue [[requirement/page/website/certificate|certificate]] | Cấp chứng chỉ cho học viên đủ điều kiện |
| Duplicate check   | Không cấp trùng user + course           |
| Generate ID       | Tạo Certificate ID duy nhất             |
| Generate PDF      | Tạo file [[requirement/page/website/certificate|certificate]] PDF                |
| Download PDF      | Cho [[requirement/page/admin/admin|admin]] tải file                      |
| Verify link       | Mở/copy link xác thực                   |
| Revoke            | Thu hồi [[requirement/page/website/certificate|certificate]] và nhập lý do       |
| Status sync       | Verify [[requirement/page|page]] hiển thị đúng valid/revoked |
...
| [[requirement/page/instructor/submissions|`submissions`]]     | Kiểm tra assignment/final project approved |
...
## Kiểm tra đủ điều kiện [[requirement/page/website/certificate|certificate]]
...
5. Chưa có [[requirement/page/website/certificate|certificate]] valid cho course đó
```
...
→ kiểm tra chưa có [[requirement/page/website/certificate|certificate]] trùng
...
## Revoke [[requirement/page/website/certificate|certificate]]
...
→ verify [[requirement/page|page]] hiển thị revoked
```
...
```text
Khi cấp [[requirement/page/website/certificate|certificate]]:
...
## Verify [[requirement/page/website/certificate|certificate]]
...
Nếu status = valid:
→ hiển thị [[requirement/page/website/certificate|certificate]] valid

Nếu status = revoked:
→ hiển thị [[requirement/page/website/certificate|certificate]] revoked

Nếu không tìm thấy:
→ hiển thị [[requirement/page/website/certificate|certificate]] not found
```
...
| `CertificateTable`        | Danh sách [[requirement/page/website/certificate|certificate]]             |
| `EligibleStudentsTable`   | Danh sách đủ điều kiện cấp        |
| `IssueCertificateModal`   | Cấp [[requirement/page/website/certificate|certificate]]                   |
| `CertificateDetailDrawer` | Xem chi tiết                      |
| `CertificateTemplateSelect` | Chọn template active khi cấp     |
| `CertificatePreview`      | Preview [[requirement/page/website/certificate|certificate]] từ template   |
| `RevokeCertificateModal`  | Thu hồi [[requirement/page/website/certificate|certificate]]               |
| `StatusBadge`             | valid / revoked                   |
| `CopyButton`              | Copy Certificate ID / verify link |
| `EmptyState`              | Khi chưa có [[requirement/page/website/certificate|certificate]]           |
...
## Chưa có [[requirement/page/website/certificate|certificate]]

```text
Chưa có chứng chỉ nào được cấp.

Khi học viên hoàn thành khóa học và final project được duyệt, [[requirement/page/admin/admin|admin]] có thể cấp chứng chỉ tại đây.
```
...
| Detail drawer     | Có thông tin [[requirement/page/website/certificate|certificate]] + actions              |
...
| Admin xem được danh sách [[requirement/page/website/certificate|certificate]]             |             |
| Admin thấy học viên đủ điều kiện cấp [[requirement/page/website/certificate|certificate]] |             |
| Không cấp được nếu học viên chưa đủ điều kiện    |             |
| Không cấp duplicate user + course                |             |
| Certificate ID được tạo unique                   |             |
| Admin cấp [[requirement/page/website/certificate|certificate]] được                       |             |
| PDF [[requirement/page/website/certificate|certificate]] được tạo hoặc lưu link           |             |
| Admin copy được verify link                      |             |
| Admin revoke [[requirement/page/website/certificate|certificate]] được                    |             |
| Revoke bắt buộc có lý do                         |             |
| Verify [[requirement/page|page]] hiển thị đúng valid/revoked          |             |
...
4. Certificate table
5. Eligible students section
6. Issue [[requirement/page/website/certificate|certificate]] modal
7. Certificate detail drawer
8. Generate Certificate ID
9. Generate/download PDF
10. Copy verify link
11. Revoke [[requirement/page/website/certificate|certificate]]
...
### Relations
- **Outgoing Links:** [[requirement/page|1. Public Website — phần người ngoài nhìn thấy]], [[requirement/page/admin/admin|Admin Dashboard — Requirement]], [[requirement/page/instructor/submissions|/instructor/submissions — Duyệt bài nộp]], [[requirement/page/website/certificate|/certificate — Trang chứng chỉ]]
