...
Trang này quản lý học viên theo góc nhìn **từng người học**, khác với `/admin/enrollments` là quản lý theo **lượt đăng ký khóa học**.
...
| CTA phụ    | `Gán khóa học` dẫn đến `/admin/enrollments`               |
...
Có thể mở modal gán khóa hoặc dẫn sang:
...
| Không có cột avatar/ảnh đại diện        |             |
...
4. Student search
5. Student table không có avatar
...
Nói ngắn gọn: **`/admin/students` là nơi admin quản lý học viên theo từng người: thông tin, nhu cầu học, khóa học, tiến độ, bài nộp và chứng chỉ. Không cần ảnh đại diện để giữ bảng gọn và thực dụng.**
