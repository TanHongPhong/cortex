...
**Lưu ý:** Chỉ [[requirement/page/admin/admin|admin]] mới có quyền quản lý học viên (gán khóa, block/unblock, xem chi tiết). Instructor không có quyền truy cập.
...
6. Xem [[requirement/page/website/certificate|certificate]] của học viên
...
Khi [[requirement/page/admin/admin|admin]] bấm `View`, mở drawer hoặc trang chi tiết.
...
Dữ liệu lấy từ form [[requirement/page/student/register|register]]/profile.
...
- enrolled_at = now
- Lưu created_by = [[requirement/page/admin/admin|admin]] hiện tại
```
...
Assignment/final_project approved → tính từ [[requirement/page/instructor/submissions|submissions]]
```
...
```text
Eligible for [[requirement/page/website/certificate|certificate]]
[Issue [[requirement/page/website/certificate|certificate]]]
```
...
**Mục đích:** [[requirement/page/admin/admin|admin]] ghi chú quá trình tư vấn/hỗ trợ học viên.
...
| Admin reset | Sau khi [[requirement/page/admin/admin|admin]] xử lý rút tiền offline, tạo `admin_withdrawal_reset` hoặc `admin_adjustment_reset` để balance về `0` |
...
| `View [[requirement/page/instructor/submissions|submissions]]`  | Xem bài nộp           |
| `View certificates` | Xem [[requirement/page/website/certificate|certificate]]       |
...
| Student có [[requirement/page/website/certificate|certificate]]   | Không xóa user                                    |
| Student có submission    | Không xóa user                                    |
| Email user               | Không nên sửa trực tiếp ở MVP                     |
| Role                     | Admin không đổi student thành [[requirement/page/admin/admin|admin]] tại trang này |
| Xóa học viên             | Không nên làm ở MVP, chỉ block/unblock            |
| Balance reset            | Chỉ [[requirement/page/admin/admin|admin]] xử lý sau withdrawal offline, bắt buộc ledger + audit |
...
| Student detail    | Xem [[requirement/page/student/profile|profile]], learning [[requirement/page/student/profile|profile]], enrollments, progress |
...
| [[requirement/page/instructor/submissions|`submissions`]]     | Assignment/final project đã nộp  |
| `certificates`    | Chứng chỉ của học viên           |
| `admin_notes`     | Ghi chú [[requirement/page/admin/admin|admin]], nếu có            |
...
Học viên sẽ xuất hiện sau khi đăng ký tài khoản hoặc được [[requirement/page/admin/admin|admin]] tạo từ lead.
```
...
| Student table | Dễ scan, hiển thị [[requirement/page/website/contact|contact]] rõ       |
...
| Hiển thị đúng [[requirement/page/instructor/submissions|submissions]] của học viên  |             |
...
7. Profile info
8. Learning [[requirement/page/student/profile|profile]]
...
Nói ngắn gọn: **`/admin/students` là nơi [[requirement/page/admin/admin|admin]] quản lý học viên theo từng người: thông tin, nhu cầu học, khóa học, tiến độ, bài nộp và chứng chỉ. Admin không cần quản lý ảnh đại diện tại đây để giữ bảng gọn và thực dụng.**
...
### Relations
- **Outgoing Links:** [[requirement/page/admin/admin|Admin Dashboard — Requirement]], [[requirement/page/instructor/submissions|/instructor/submissions — Duyệt bài nộp]], [[requirement/page/student/profile|/profile — Hồ sơ cá nhân]], [[requirement/page/student/register|/register — Đăng ký tài khoản]], [[requirement/page/website/certificate|/certificate — Trang chứng chỉ]], [[requirement/page/website/contact|/contact — Trang liên hệ]]
