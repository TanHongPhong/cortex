...
5. Cấp và kiểm soát [[requirement/page/website/certificate|certificate]]
6. Quản lý đơn hàng, [[requirement/page/student/coupon|coupon]], thanh toán và biên nhận
7. Quản lý announcement, review, template [[requirement/page/website/certificate|certificate]], audit log
...
| Khu vực             | Nội dung                                                                                |
| ------------------- | --------------------------------------------------------------------------------------- |
| KPI cards           | Tổng học viên, tổng khóa học, đơn paid/pending, doanh thu, bài nộp chờ duyệt, [[requirement/page/website/certificate|certificate]] đã cấp |
| Pending [[requirement/page/instructor/submissions|submissions]] | Assignment/final project đang chờ duyệt                                                 |
...
| Pending [[requirement/page/instructor/submissions|submissions]] | Bài nộp đang chờ duyệt            |
| Certificates issued | Số chứng chỉ đã cấp               |
| New leads           | Số lead Type B mới ([[requirement/page/website/contact|contact]] [[requirement/page|page]]) |
| Open [[requirement/page/instructor/questions|questions]]      | Câu hỏi lesson chưa trả lời       |
| Pending reviews     | Review khóa học chờ duyệt         |
| Failed [[requirement/page/student/notifications|notifications]] | Notification delivery lỗi        |
...
| Status                | draft / published / archived                     |
| Certificate available | Có [[requirement/page/website/certificate|certificate]] không                             |
...
Theo dõi học viên, tiến độ học, khóa đã đăng ký, bài nộp và [[requirement/page/website/certificate|certificate]].
...
| Student detail | Xem khóa đã đăng ký, tiến độ, [[requirement/page/instructor/submissions|submissions]], [[requirement/page/website/certificate|certificate]] |
...
Final project approved → học viên đủ điều kiện xét [[requirement/page/website/certificate|certificate]] nếu đã hoàn thành các lesson bắt buộc.
```
...
| Order detail | Billing, [[requirement/page/student/coupon|coupon]]/referral, payment transactions, invoice, enrollment |
...
Tạo/sửa/tạm dừng [[requirement/page/student/coupon|coupon]] và theo dõi [[requirement/page/student/coupon|coupon]] redemptions.
...
Các trang commerce phụ trợ để đối soát giao dịch, xuất biên nhận, theo dõi [[requirement/page/student/referral|referral]] và báo cáo doanh thu.
...
| `/admin/referrals` | Theo dõi [[requirement/page/student/referral|referral]] codes, conversions, reward |
| `/admin/revenue` | P2 [[requirement/page/student/dashboard|dashboard]] doanh thu theo thời gian/course/payment/coupon |
...
[[requirement/page/student/referral|referral]] reward chỉ active khi order paid.
...
Cấp và kiểm soát [[requirement/page/website/certificate|certificate]].
...
Chỉ cấp [[requirement/page/website/certificate|certificate]] khi học viên đủ điều kiện.
```

## Điều kiện cấp [[requirement/page/website/certificate|certificate]]
...
5. Chưa từng được cấp [[requirement/page/website/certificate|certificate]] cho khóa đó
```
...
```text
/admin/coupons
→ tạo [[requirement/page/student/coupon|coupon]] và usage rule
→ [[requirement/page/student/checkout|checkout]] validate [[requirement/page/student/coupon|coupon]]
...
→ assignment/final_project nộp vào [[requirement/page/instructor/submissions|submissions]]
...
## Flow 7 — Cấp [[requirement/page/website/certificate|certificate]]
...
→ generate PDF
→ status = valid
→ học viên thấy [[requirement/page/website/certificate|certificate]] ở /my-certificates
```
...
| `StatusBadge`        | Trạng thái khóa, order, payment, submission, [[requirement/page/website/certificate|certificate]] |
| `SearchFilterBar`    | Tìm kiếm/lọc                                 |
| `CreateEditModal`    | Tạo/sửa dữ liệu                              |
| `ConfirmDialog`      | Xóa, revoke, block                           |
| `FeedbackBox`        | Duyệt [[requirement/page/instructor/submissions|submissions]]                            |
| `OrderDetailDrawer`  | Chi tiết order/payment/invoice               |
| `CouponFormModal`    | Tạo/sửa [[requirement/page/student/coupon|coupon]]                               |
| `PaymentLogDrawer`   | Xem payment transaction/webhook payload      |
| `CertificatePreview` | Quản lý [[requirement/page/website/certificate|certificate]]                          |
...
| [[requirement/page/instructor/submissions|`submissions`]]      | Bài nộp assignment/final project           |
| `certificates`     | Chứng chỉ                                  |
| `orders`           | Đơn hàng, doanh thu, [[requirement/page/student/checkout|checkout]]              |
| `coupons`          | Mã giảm giá                                |
| `coupon_redemptions` | Lịch sử dùng [[requirement/page/student/coupon|coupon]]                      |
...
| `referral_conversions` | Conversion/reward [[requirement/page/student/referral|referral]]              |
| `announcements`    | Thông báo global/course                    |
| [[requirement/page/student/notifications|`notifications`]]    | Delivery thông báo in-app cá nhân          |
...
Admin mới được tạo/sửa/archive [[requirement/page/student/coupon|coupon]].
Admin mới được cấp/revoke [[requirement/page/website/certificate|certificate]].
...
Instructor không cấp/revoke [[requirement/page/website/certificate|certificate]].
```
...
## Phase 4 — Duyệt bài và [[requirement/page/website/certificate|certificate]]
...
1. /admin
   - KPI (students, enrollments, courses, orders, revenue, [[requirement/page/instructor/submissions|submissions]], certificates, new leads)
   - Pending [[requirement/page/instructor/submissions|submissions]]
   - Quick actions
...
4. /admin/coupons
   - Coupon table
   - Create/edit [[requirement/page/student/coupon|coupon]]
...
10. /admin/certificates
   - Cấp [[requirement/page/website/certificate|certificate]]
...
13. /admin/announcements
   ...
   - Publish -> create [[requirement/page/student/notifications|notifications]]
...
15. /admin/certificate-templates
   - Manage active [[requirement/page/website/certificate|certificate]] templates
...
| Admin role có quyền commerce, content, [[requirement/page/website/certificate|certificate]], P1 ops | |
| Instructor không có quyền commerce/revenue/payment/coupon/invoice | |
| Data chính khớp [[requirement/unified_database_schema|`unified_database_schema.md`]] | |
...
### Relations
- **Outgoing Links:** [[requirement/page|1. Public Website — phần người ngoài nhìn thấy]], [[requirement/page/instructor/questions|/instructor/questions — Trả lời Q&A]], [[requirement/page/instructor/submissions|/instructor/submissions — Duyệt bài nộp]], [[requirement/page/student/checkout|/checkout/:courseSlug — Thanh toán khóa học]], [[requirement/page/student/coupon|/coupon — Coupon của tôi / Nhập mã giảm giá]], [[requirement/page/student/dashboard|/dashboard — Trang tổng quan học viên]], [[requirement/page/student/notifications|/notifications — Thông báo của tôi]], [[requirement/page/student/referral|/referral — Mã giới thiệu]], [[requirement/page/website/certificate|/certificate — Trang chứng chỉ]], [[requirement/page/website/contact|/contact — Trang liên hệ]], [[requirement/unified_database_schema|💎 Unified Database Schema - CORTEX Project]]
- **Incoming Links (Backlinks):** [[PLAN_CONFLICT_AUDIT|Plan Conflict Audit - CORTEX Requirements]], [[requirement/architecture|Architecture — Kiến trúc kỹ thuật CORTEX]], [[requirement/hard_notes|Hard Notes]], [[requirement/page|1. Public Website — phần người ngoài nhìn thấy]], [[requirement/page/admin/admin-announcements|/admin/announcements — Quản lý thông báo]], [[requirement/page/admin/admin-certificates|/admin/certificates — Quản lý chứng chỉ]], [[requirement/page/admin/admin-courses|/admin/courses — Quản lý khóa học]], [[requirement/page/admin/admin-leads|/admin/leads — Quản lý Type B Leads]], [[requirement/page/admin/admin-lessons|/admin/lessons — Quản lý module/bài học]], [[requirement/page/admin/admin-orders|/admin/orders — Quản lý đơn hàng]], [[requirement/page/admin/admin-overview|/admin — Admin Overview]], [[requirement/page/admin/admin-resources|/admin/resources — Quản lý Resources Hub]], [[requirement/page/admin/admin-students|/admin/students — Quản lý học viên]], [[requirement/page/admin/admin-submissions|/admin/submissions — Duyệt bài nộp]], [[requirement/page/admin/admin-system-users-new|/admin/system/users/new — Hidden Staff Account Creation]], [[requirement/page/instructor/courses|/instructor/courses — Khóa được phân công]], [[requirement/page/instructor/overview|/instructor — Instructor Overview]], [[requirement/page/instructor/submissions|/instructor/submissions — Duyệt bài nộp]], [[requirement/page/student/assignments|/assignments — Legacy / Không ưu tiên MVP]], [[requirement/page/student/checkout|/checkout/:courseSlug — Thanh toán khóa học]], [[requirement/page/student/checkout-result|/checkout/success và /checkout/failed — Kết quả thanh toán]], [[requirement/page/student/dashboard|/dashboard — Trang tổng quan học viên]], [[requirement/page/student/learn-lesson|/learn/course/lesson — Trang bài học]], [[requirement/page/student/login|/login — Đăng nhập]], [[requirement/page/student/my-courses|/my-courses — Khóa học của tôi]], [[requirement/page/student/my-orders|/my-orders và /my-orders/:id — Đơn hàng của tôi]], [[requirement/page/student/profile|/profile — Hồ sơ cá nhân]], [[requirement/page/student/register|/register — Đăng ký tài khoản]], [[requirement/page/website/blog|/blog — Blog / Resources Hub]], [[requirement/page/website/maintenance|/maintenance — Trang bảo trì hệ thống]], [[requirement/page/website/refund-policy|/refund-policy — Chính sách refund]], [[requirement/page_function_matrix|Page Function Matrix — CORTEX]], [[requirement/security|Security — Bảo mật hệ thống CORTEX]], [[requirement/unified_database_schema|💎 Unified Database Schema - CORTEX Project]]
