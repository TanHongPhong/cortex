...
| `/404` | Trang không tìm thấy (system page) | static | `/`, `/courses`, search |
| `/500` | Trang lỗi server (system page) | static, Sentry logging | retry, `/`, `/contact?type=support` |
| `/maintenance` | Trang bảo trì (system page) | `maintenance_status` API, countdown | auto-refresh khi hết thời gian |
