...
**Rule:** chỉ lấy `[[web/page/student/notifications|notifications]].user_id = current_user.id`.
...
| Approved      | Bài nộp đã được duyệt        | `Tiếp tục học` hoặc `Xem [[web/page/website/certificate|certificate]]` |
...
**Nếu rejected:** hiển thị feedback ngắn từ [[web/page/admin/admin|admin]].
...
| Status       | Hiển thị                           | CTA               |
| ------------ | ---------------------------------- | ----------------- |
| Not eligible | Chưa đủ điều kiện nhận [[web/page/website/certificate|certificate]] | `Xem điều kiện`   |
| Eligible     | Đủ điều kiện, chờ cấp [[web/page/website/certificate|certificate]]  | `Xem trạng thái`  |
| Issued       | Certificate đã được cấp            | `Tải [[web/page/website/certificate|certificate]]` |
...
**Điều kiện [[web/page/website/certificate|certificate]]:**
...
→ chuyển CTA sang /my-certificates hoặc trạng thái [[web/page/website/certificate|certificate]].
```
...
## Logic [[web/page/website/certificate|certificate]]
...
Nếu final_project approved nhưng chưa cấp [[web/page/website/certificate|certificate]]:
→ Eligible

Nếu [[web/page/website/certificate|certificate]] đã cấp:
→ Issued
```
...
Các phần assignment/final project, [[web/page/website/certificate|certificate]], my courses có thể nằm bên dưới nhưng vẫn trong dashboard, không cần cuộn quá dài.
...
| Hiển thị đúng trạng thái [[web/page/website/certificate|certificate]]                             |             |
