...
| Subtitle   | “Xem, tải và xác thực các chứng chỉ bạn đã nhận tại Blueprint.” |
...
Certificate của bạn đang chờ Blueprint xử lý.
...
- `{YYYYRRRR}`: 8 chữ số gồm năm cấp chứng chỉ `YYYY` + 4 chữ số ngẫu nhiên `RRRR`
