...
Build your first AI landing [[web/page|page]]
...
- Cách mô tả ý tưởng landing [[web/page|page]] cho AI
...
| Template         | Template landing [[web/page|page]] / workflow |
...
| Thành phần      | Yêu cầu                                      |
| --------------- | -------------------------------------------- |
| Tên bài tập     | Ví dụ: Bài tập: Viết prompt tạo landing [[web/page|page]] |
...
```text
Bài tập: Viết prompt tạo landing [[web/page|page]]

Yêu cầu:
Hãy viết một prompt hoàn chỉnh để yêu cầu AI tạo landing [[web/page|page]] cho một khóa học online.

Output cần nộp:
- Prompt hoàn chỉnh
- Mô tả ngắn ý tưởng landing [[web/page|page]]
- Link kết quả nếu có
```
...
| Ghi chú           | Không          | Gửi thêm cho [[web/page/admin/admin|admin]]/mentor         |
...
- Tạo/cập nhật record trong [[web/page/instructor/submissions|submissions]]
- status = pending
...
Học viên nộp project cuối khóa để được xét hoàn thành khóa và nhận [[web/page/website/certificate|certificate]].
...
- Landing [[web/page|page]] tạo bằng AI
...
Hiển thị rõ điều kiện nhận [[web/page/website/certificate|certificate]]:
...
- Nếu đủ điều kiện, học viên có thể nhận [[web/page/website/certificate|certificate]]
```
...
| Submission         | Assignment/final project lưu vào [[web/page/instructor/submissions|`submissions`]]          |
...
# 13. Cấu trúc dữ liệu [[web/page/instructor/submissions|`submissions`]]
...
| Final project lesson hiển thị project brief, form nộp project, status, feedback, [[web/page/website/certificate|certificate]] condition |             |
| Bấm hoàn thành video thì lưu `lesson_progress`                                                         |             |
| Nộp assignment/final project thì lưu [[web/page/instructor/submissions|`submissions`]]                                                     |             |
