...
5. Cấu hình khóa có [[web/page/website/certificate|certificate]] hay không
...
**Rule:**
Premium và B2B vẫn có thể lưu trong `courses`, nhưng ngoài public [[web/page|page]] `/courses` thì nên tách thành section riêng, không gộp chung 4 course card chính.
...
archived → không hiển thị public, [[web/page/admin/admin|admin]] vẫn xem được
```
...
| Certificate available = true | Khóa có thể cấp [[web/page/website/certificate|certificate]] khi học viên đủ điều kiện  |
...
| `certificates` | Kiểm tra [[web/page/website/certificate|certificate]] liên quan nếu cần |
...
Nên có thêm `display_order` để [[web/page/admin/admin|admin]] kiểm soát thứ tự 4–6 khóa.
...
Nếu thiếu thông tin:
→ báo [[web/page/admin/admin|admin]] bổ sung trước khi publish
```
