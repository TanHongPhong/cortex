...
**Lưu ý:** Chỉ [[web/page/admin/admin|admin]] mới có quyền upload video và quản lý nội dung khóa học tại trang này. Instructor không có quyền truy cập.
...
CTA [[web/page/admin/admin|admin]]:
...
| Correct answers         | Có       | Chỉ [[web/page/admin/admin|admin]]/instructor xem; `short_text` lưu accepted answers để auto-grade exact/normalized match |
...
| Certificate condition note | Có       | Nêu điều kiện để nhận [[web/page/website/certificate|certificate]] |
| Requires submission        | Có       | true                              |
...
Khi [[web/page/admin/admin|admin]] chọn lesson type = video, hiển thị bảng quản lý video assets:
...
- **Student playback**: Backend kiểm tra [[web/page/student/login|login]] + enrollment active + analysis/lesson published trước khi trả embed_url.
...
Vì khóa học cần flow rõ, [[web/page/admin/admin|admin]] nên chỉnh được thứ tự.
...
| Assignment thiếu web/rubric      | Không cho publish                                      |
...
| [[web/page/instructor/submissions|`submissions`]]      | Kiểm tra assignment/final project đã có bài nộp chưa |
...
| Assignment bắt buộc có web/rubric khi publish            |             |
...
Nói ngắn gọn: **`/admin/lessons` là nơi [[web/page/admin/admin|admin]] xây toàn bộ nội dung học của khóa: module, video bài giảng, tài liệu, quiz, bài tập và final project. Đây là trang quan trọng nhất để tạo trải nghiệm học trong Student Portal.**
