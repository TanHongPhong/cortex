...
lesson progress
course completion
[[web/page/website/certificate|certificate]] eligibility
```
...
- Approved
- Rejected
- Final [[web/page/website/projects|projects]] pending
...
| Approved [[web/page/instructor/submissions|submissions]]   | Bài đã duyệt                 |
| Rejected [[web/page/instructor/submissions|submissions]]   | Bài bị trả lại               |
| Final [[web/page/website/projects|projects]] pending | Final project đang chờ duyệt |
...
```text
Hiển thị pending [[web/page/instructor/submissions|submissions]] trước.
```
...
Khi [[web/page/admin/admin|admin]] bấm `Review`, mở drawer hoặc modal chi tiết.
...
| `Request revision` | Set `[[web/page/instructor/submissions|submissions]].status = revision_requested`, học viên được nộp attempt mới |
| `Reject`           | Set `[[web/page/instructor/submissions|submissions]].status = rejected`, không tính hoàn thành |
...
| ---------- | --------------- | --------------------------- |
| `pending`  | Chờ [[web/page/admin/admin|admin]] duyệt | Chưa tính hoàn thành        |
...
| Final project approved      | Học viên có thể đủ điều kiện [[web/page/website/certificate|certificate]]                     |
| Projects independence       | Submissions không tự động thành [[web/page/website/projects|projects]]; [[web/page/admin/admin|admin]] chủ động tạo |
...
| Certificate relation | Final project approved thì kiểm tra điều kiện [[web/page/website/certificate|certificate]] |
...
| Bảng              | Dữ liệu                            |
| ----------------- | ---------------------------------- |
| [[web/page/instructor/submissions|`submissions`]]     | Bài nộp                            |
...
| `certificates`    | Kiểm tra điều kiện cấp [[web/page/website/certificate|certificate]] |
| `enrollments`     | Kiểm tra khóa học của học viên     |

---

# 14. Cấu trúc dữ liệu [[web/page/instructor/submissions|`submissions`]]
...
| `status`          | pending / approved / revision_requested / rejected |
| `feedback`        | Nhận xét [[web/page/admin/admin|admin]]                    |
...
## Lấy danh sách [[web/page/instructor/submissions|submissions]]

```text
Lấy [[web/page/instructor/submissions|submissions]]
...
Admin bấm Approve
→ confirm
→ [[web/page/instructor/submissions|submissions]].status = approved
→ feedback = feedback [[web/page/admin/admin|admin]] nhập
→ reviewed_at = hiện tại
→ reviewed_by = [[web/page/admin/admin|admin]] hiện tại (audit trail)
→ updated_by = [[web/page/admin/admin|admin]] hiện tại
...
→ [[web/page/instructor/submissions|submissions]].status = revision_requested nếu cần học viên sửa và nộp lại
→ [[web/page/instructor/submissions|submissions]].status = rejected nếu từ chối hẳn
→ reviewed_at = hiện tại
→ reviewed_by = [[web/page/admin/admin|admin]] hiện tại (audit trail)
→ updated_by = [[web/page/admin/admin|admin]] hiện tại
...
→ nếu đủ điều kiện:
   học viên eligible for [[web/page/website/certificate|certificate]]
```
...
| Admin xem được danh sách [[web/page/instructor/submissions|submissions]]                            |             |
| Pending [[web/page/instructor/submissions|submissions]] hiển thị ưu tiên                            |             |
...
| Final project approved có thể kích hoạt eligibility [[web/page/website/certificate|certificate]] |             |
...
Nói ngắn gọn: **`/admin/submissions` là nơi [[web/page/admin/admin|admin]] duyệt bài tập và final project. Approve thì bài học được tính hoàn thành; reject thì học viên phải sửa và nộp lại. Final project approved là bước quan trọng để xét [[web/page/website/certificate|certificate]].**
