...
Các trang commerce phụ trợ để đối soát giao dịch, xuất biên nhận, theo dõi [[web/page/student/referral|referral]] và báo cáo doanh thu.
...
| `/admin/referrals` | Theo dõi [[web/page/student/referral|referral]] codes, conversions, reward |
| `/admin/revenue` | P2 [[web/page/student/dashboard|dashboard]] doanh thu theo thời gian/analysis/payment/coupon |
