...
| Student | 403 |
| Instructor | 403 |
| Admin | Được tạo [[[[web/page/admin/admin|web/page/admin/admin]]|[[web/page/admin/admin|`admin`]]]], `instructor` hoặc `course_editor` |
...
| `phone` | Optional |
| `role` | Chỉ cho chọn [[[[web/page/admin/admin|web/page/admin/admin]]|[[web/page/admin/admin|`admin`]]]], `instructor` hoặc `course_editor` |
...
Khi `role = course_editor`, không tạo `course_instructors` và không cấp quyền instructor. User này chỉ dùng role-level guard để vào `/admin/courses*` và `/admin/lessons*`; sidebar chỉ hiện Courses và Lessons.
...
| Tạo course editor | `users` | `user.create_course_editor` |
...
| Admin mở route trực tiếp | Thấy form tạo [[[[web/page/admin/admin|web/page/admin/admin]]|[[web/page/admin/admin|`admin`]]]]/`instructor`/`course_editor` |
...
| Tạo course editor thành công | Có `users.role = course_editor`, `created_by`, `audit_logs.action = user.create_course_editor`, không tạo `course_instructors` |
